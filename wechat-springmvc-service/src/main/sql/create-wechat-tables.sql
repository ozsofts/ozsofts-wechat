...
ALTER TABLE t_wx_users CHANGE nick_name nick_name VARCHAR(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;


drop table if exists t_wx_xmlmessages;
create table t_wx_xmlmessages (
  `id` bigint not null auto_increment,
